(function(g, m) {
	...
	function db(a, b) {
		...
		for (var e = 0; e < d; ++e) {
			...
			b += 8;
			l && h && (h.S(), h.ox = h.x, h.oy = h.y, h.o = h.size, h.D = l.x, h.F = l.y, h.n = h.size, h.L = H)
		}
		for (e = 0;;) {
			d = a.getUint32(b, !0);
			b += 4;
			...
			r = n;
			n = null;
			A.hasOwnProperty(d) ? (n = A[d], n.K(), n.ox = n.x, n.oy = n.y, n.o = n.size, n.color = g) : (n = new Oa(d, l, h, f, g, r), v.push(n), A[d] = n, n.ka = l, n.la = h);
			n.isVirus = q;
			n.j = s;
			n.D = l;
			n.F = h;
		...
		if ("undefined" == typeof console || "undefined" == typeof DataView || "undefined" == typeof WebSocket || null == Ua || null == Ua.getContext || null == g.localStorage) alert("You browser does not support this game, we recommend you to use Firefox to play this");
			...
			Oa.prototype = {
				...
				K: function() {
					...
					this.x = a * (this.D - this.ox) + this.ox;
					this.y = a * (this.F - this.oy) + this.oy;
				...
				T: function(a) {
					if (this.I()) {
						...
						if (0 != this.id) {
							...
							Ta && (c || 0 == p.length && (!this.isVirus || this.j) && 20 < this.size) && (null == this.J && (this.J = new na(this.h() / 2, "#FFFFFF", !0, "#000000")), c = this.J, c.H(this.h() / 2), c.u(~~(this.size * this.size / 100)), d = Math.ceil(10 * k) / 10, c.$(d), e = c.G(), l = ~~(e.width / d), h = ~~(e.height / d), a.drawImage(e, ~~this.x - ~~(l / 2), b - ~~(h / 2),
								l, h))
						}
						a.restore()
					}
